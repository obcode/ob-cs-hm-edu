...
<div class="container-fluid">
  <div class="row jumbotron">
    <div class="col-12 text-center">
      <h1 class="display-6">Datenschutzerklärung</h1>
    </div>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-lg-12">
      <p>
        ...
        Funktionen und Inhalte auf. (nachfolgend gemeinsam bezeichnet als
      ...
      <h5>Ansprechpartner in der Fakultät Informatik und Mathematik</h5>
      <p>
        ...
        <br />
        Tel. +49 89 1265-3790, Fax -3780
        <br />
        E-Mail: oliver.braun@hm.edu
      </p>
      <h5>Kontaktdaten des bestellten behördlichen Datenschutzbeauftragten</h5>
      <p>
        Dieter Sablic
        <br />
        Lothstraße 34
      ...
      <h5>Keine verarbeiteten Benutzer-Daten</h5>
      <p>
        Diese Website stellt ausschließlich Informationen des Ansprechpartners
        zur Verfügung. Es gibt keine Cookies und keine Login-Möglichkeiten. Die
        Website besteht ausschließlich aus statischem Content.
      </p>
      <h5>Maßgebliche Rechtsgrundlagen</h5>
      <p>
        Die DSGVO ist nach Maßgabe des Art. 2 Bayerisches Datenschutzgesetz –
        BayDSG anwendbar. Nach Maßgabe des Art. 13 DSGVO teilen wir Ihnen die
        ...
        1 lit. b DSGVO, und die Rechtsgrundlage für die Datenverarbeitung, die
        zur Erfüllung unserer Aufgaben als Hochschule notwendig ist, ist Art. 4
        Abs. 1 BayDSG in Verbindung mit Art. 6 Abs. 1 e DSGVO bzw. Art. 2 BayDSG
        und. Art. 2 Bayerischen Hochschulgesetz - BayHSchG, Art. 4 Abs. 1 S. 1
        und 2 Bayerisches E-Government-Gesetz - BayEGovG. Für den Fall, dass
      ...
      <h5>Rechte der betroffenen sonstigen Nutzer</h5>
      <p>
      ...
      <p>
        ...
        schließt. In einem solchen Cookie kann z.B. ein Login-Status gespeichert
      ...
      <h5>Löschung von Daten der sonstigen Nutzer</h5>
      <p>
      ...
      <p>
        Wir verarbeiten im Rahmen der Erfüllung unserer Aufgaben nach Art. 4
        Abs. 1 BayDSG in Verbindung mit Art. 6 Abs. 1 BayDSG, § 13 Abs. 7 TMG,
        Art. 11 Abs. 1 BayEGovG zur Gewährleistung der Netz- und
        Informationssicherheit Daten über jeden Zugriff auf den Server, auf dem
      ...
      <p>
        ...
        Telefon) werden die Angaben der sonstigen Nutzer zur Bearbeitung der
        Kontaktanfrage und deren Abwicklung gem. Art. 6 Abs. 1 lit. b) DSGVO
        bzw. Art. 4 Abs. 1 BayDSG in Verbindung mit Art. 2 BayHSchG verarbeitet.
        Die Angaben der sonstigen Nutzer können in einem IT System
        (“Anfrageverwaltungssystem”) gespeichert werden.
      </p>
      <p>
